...
import br.ucsal.orchestrator_service.service.OrchestrationService; // <-- IMPORT NECESSÁRIO
...
import br.ucsal.orchestrator_service.dto.ProgramaRequestDTO; // <-- Importado para o argThat
...
class OrchestrationServiceTest {
    ...
    void shouldExecuteFullOrchestrationSuccessfully() {
        ...
        // O argThat garante que o objeto passado é um ProgramaRequestDTO e contém os IDs corretos.
        verify(programClient, times(1)).createPrograma(argThat((ProgramaRequestDTO dto) -> { // <-- CORREÇÃO: Usando ProgramaRequestDTO
